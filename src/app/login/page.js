  ...
  return (
    <>
      ...
      <div className="max-w-md mx-auto mt-12 p-6 bg-white rounded-xl shadow-md">
        <h1 className="text-2xl font-bold mb-6 text-pink-600">Iniciar sesión</h1>
        ...
        <p className="mt-4 text-sm text-center">
          ¿No tienes cuenta?{" "}
          <Link href="/registro" className="text-pink-600 font-semibold">
            Regístrate
          </Link>
        </p>

        <p className="mt-4 text-xs text-center text-gray-400">
          Admin de prueba: admin@postresya.com / admin123
        </p>
      </div>
    </>
  );
